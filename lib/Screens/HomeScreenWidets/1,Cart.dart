...
import 'package:ghioon_buyer/Screens/HomeScreenWidets/1,CartWidgets/cartListItem.dart';
...
import '1,CartWidgets/ChooseLocation.dart';
            ...
            return Padding(
              ...
              child: FractionallySizedBox(
                ...
                child: Container(
                    ...
                    child: const ChooseDeliveryLocation()),
              ),
            );
          });
    }
        ...
        child: ListView(
          children: [
            cart.cartList.isNotEmpty
                ...
                : Container(
                    height: ScreenSize().ScreenHeight(context) * 0.55,
                    child: EmptyScreen(context, "No Product in Cart")),
            Container(
              decoration: BoxDecoration(
                color: CustomColors().white,
                        ...
                        child: Row(
                          ...
                          children: [
                            Expanded(
                              ...
                              child: TextFormFieldWithOutLabel("Promo Code",
                                  cart.promoCode, TextInputType.text),
                            )),
                            Padding(
                              padding: const EdgeInsets.all(8.0),
                              child: Container(
                                height:
                                    ScreenSize().ScreenHeight(context) * 0.06,
